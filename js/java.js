...
jQuery(document).ready(function($) {
    $('.owl-carousel').owlCarousel({
        loop: true,           // چرخش بی‌نهایت فعال
        margin: 10,          // فاصله بین اسلایدها
        nav: true,           // دکمه‌های ناوبری فعال
        autoplay: true,      // فعال کردن پخش خودکار
        autoplayTimeout: 3000, // زمان بین اسلایدها (میلی‌ثانیه)
        autoplayHoverPause: true, // توقف پخش خودکار با هاور
        responsive: {
            0: {
                items: 1     // تعداد آیتم‌ها برای موبایل
            },
            600: {
                items: 3     // تعداد آیتم‌ها برای تبلت
            },
            1000: {
                items: 5     // تعداد آیتم‌ها برای دسکتاپ
            }
        }
    });
});
